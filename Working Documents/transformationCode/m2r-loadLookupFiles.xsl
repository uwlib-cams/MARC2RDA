...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="lc_files" select="'subjectSchemes;genreFormSchemes;fingerprintschemes;identifiers;accessrestrictionterm;classSchemes;carriers;contentTypes;mediaTypes;mplayspeed;mtapeconfig;mencformat;nameTitleSchemes'"/>
